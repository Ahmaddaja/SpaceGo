...
>>>>>>> 5eba74fc2dc4e55501debd9b3699b4591d496457
            </div>
            ...
            <div class="grid md:grid-cols-2 gap-12 items-center">
                <div>
                    ...
                    <p class="text-xl text-gray-700 mb-8 leading-relaxed">
                        Solusi penyimpanan yang aman, fleksibel, dan terjangkau. Kelola inventori Anda dengan mudah
                        bersama SPACEGO.
                    </p>
                ...
                <div class="flex justify-center">
                    <svg viewBox="0 0 500 400" class="w-full max-w-lg">
                        ...
                        <!-- Cloud 1 -->
                        <ellipse cx="100" cy="60" rx="30" ry="20" fill="#BDC3FF"
                            opacity="0.6" />
                        <ellipse cx="125" cy="55" rx="25" ry="18" fill="#BDC3FF"
                            opacity="0.6" />

                        <!-- Cloud 2 -->
                        <ellipse cx="380" cy="70" rx="35" ry="22" fill="#BDC3FF"
                            opacity="0.6" />
                        <ellipse cx="410" cy="65" rx="28" ry="20" fill="#BDC3FF"
                            opacity="0.6" />
                    </svg>
                </div>
            </div>
