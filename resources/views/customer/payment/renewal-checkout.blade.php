            ...
            <div class="checkout-container px-4">
                ...
                @php
                    ...
                    $daysDiff = isset($daysDiff)
                        ? $daysDiff
                        : (int) \Carbon\Carbon::parse($sewaBerahir)
                            ->startOfDay()
                    ...
                    <div class="p-8">
                        ...
                        <div class="mb-6">
                            ...
                            @if ($daysDiff < 0)
                                <div class="detail-row">
                                    <span
                                        class="@if ($isOverdue) text-red-600 @else text-yellow-600 @endif font-semibold">
                                        Status
                                    </span>
                                    <span
                                        class="font-bold @if ($isOverdue) text-red-600 @else text-yellow-600 @endif">
                                        @if ($isInGracePeriod)
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-700">
                                            ...
                                            <br><br>
                                            <strong>Keterlambatan: {{ $latenessDays }} hari setelah masa
                                                tenggang</strong><br>
                                            Denda: Rp {{ number_format($dendaPerHari, 0, ',', '.') }}/hari ×
                                            {{ $latenessDays }} hari = <strong class="text-red-700">Rp
                                                {{ number_format($calculatedDenda, 0, ',', '.') }}</strong>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="info-box" style="background: #fef3c7; border-left-color: #f59e0b;">
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-700">
                                            Masa sewa berakhir <strong>{{ abs($daysDiff) }} hari</strong> yang lalu, tetapi
                                            ...
                                            ⏰ Sisa waktu masa tenggang: <strong>{{ $gracePeriodDays - abs($daysDiff) }}
                                                hari lagi</strong><br>
                                            💡 Perpanjang sekarang untuk menghindari denda Rp
                                ...
                                <div class="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm text-gray-700">
                                            ...
                                            @elseif($daysDiff > 0)
                                                Anda melakukan perpanjangan <strong>{{ $timeBeforeExpiry }}
                                                    sebelum</strong> masa sewa berakhir.
                                            @endif
                                            <br><br>
                                ...
                                <div class="detail-row">
                                    <span class="text-red-600 font-semibold">
                                        ...
                                        <div class="text-xs text-gray-600 font-normal mt-1">
                                            {{ $latenessDays }} hari × Rp
                                            {{ number_format($dendaPerHari, 0, ',', '.') }}/hari<br>
                        ...
                        @if ($isInGracePeriod)
                            ...
                            <div class="mt-4 p-4 bg-yellow-50 rounded-lg border border-yellow-200">
                                ...
                                <p class="text-sm text-yellow-800">
                                    Masa tenggang adalah periode {{ $gracePeriodDays }} hari setelah masa sewa berakhir
                                    dimana Anda tidak dikenakan denda.
                                    Saat ini Anda berada di hari ke-{{ abs($daysDiff) }} dari {{ $gracePeriodDays }} hari
                                    masa tenggang.
                                    Jika melewati masa tenggang, denda Rp
                                    {{ number_format($dendaPerHari, 0, ',', '.') }}/hari akan mulai dikenakan.
                                </p>
                            </div>
                        @endif
