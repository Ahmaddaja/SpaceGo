...
<div class="py-12">
    <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
        <!-- Back Button -->
        <a href="{{ route('customer.list-rak.list-rak') }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 mb-8 transition-all duration-300 back-button group">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden border border-gray-100 payment-card">
            ...
            <div class="p-8">
                ...
                <!-- Payment Button -->
                <button id="pay-button" class="w-full pay-button text-white py-4 rounded-xl font-bold text-lg transition-all duration-300 shadow-lg flex items-center justify-center group">
