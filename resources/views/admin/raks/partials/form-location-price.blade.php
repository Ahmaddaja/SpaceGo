    ...
    <div class="card-body">
        <div class="form-group">
            ...
            <input type="text" 
                   ...
                   id="lokasi_gudang" 
                   name="lokasi_gudang" 
                   value="{{ old('lokasi_gudang', $rak->lokasi_gudang ?? '') }}"
        ...
        <div class="form-group">
            ...
            <select class="form-control @error('status') is-invalid @enderror" 
                    id="status" 
                    name="status">
                <option value="tersedia" {{ old('status', $rak->status ?? '') == 'tersedia' ? 'selected' : '' }}>Tersedia</option>
                <option value="terisi" {{ old('status', $rak->status ?? '') == 'terisi' ? 'selected' : '' }}>Terisi</option>
                <option value="maintenance" {{ old('status', $rak->status ?? '') == 'maintenance' ? 'selected' : '' }}>Maintenance</option>
            </select>
            @error('status')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
