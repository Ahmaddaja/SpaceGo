            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 font-weight-bold text-success">Rp {{ number_format($pendapatanBulanIni, 0, ',', '.') }}</h3>
                    </div>
            ...
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h3 class="mb-0 font-weight-bold text-warning">Rp {{ number_format($totalPendapatan, 0, ',', '.') }}</h3>
                    </div>
